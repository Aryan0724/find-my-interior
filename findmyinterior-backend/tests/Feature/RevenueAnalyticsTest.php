...
class RevenueAnalyticsTest extends TestCase
{
    ...
    public function test_funnel_metrics_calculate_conversion_rates(): void
    {
        ...
        $req1 = DB::table('requirements')->insertGetId(['user_id' => $customer->id, 'category_id' => $categoryId, 'title' => 'Req1', 'status' => 'completed', 'description' => 'x', 'project_type' => 'residential', 'city' => 'City', 'district' => 'Dist', 'name' => 'Name', 'phone' => '1234567890', 'created_at' => now(), 'updated_at' => now()]);
        $req2 = DB::table('requirements')->insertGetId(['user_id' => $customer->id, 'category_id' => $categoryId, 'title' => 'Req2', 'status' => 'awarded', 'description' => 'x', 'project_type' => 'residential', 'city' => 'City', 'district' => 'Dist', 'name' => 'Name', 'phone' => '1234567890', 'created_at' => now(), 'updated_at' => now()]);
        $req3 = DB::table('requirements')->insertGetId(['user_id' => $customer->id, 'category_id' => $categoryId, 'title' => 'Req3', 'status' => 'open', 'description' => 'x', 'project_type' => 'residential', 'city' => 'City', 'district' => 'Dist', 'name' => 'Name', 'phone' => '1234567890', 'created_at' => now(), 'updated_at' => now()]);
